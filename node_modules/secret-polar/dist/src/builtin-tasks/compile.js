...
var checkEnv_1 = require("../lib/compile/checkEnv");
var compile_1 = require("../lib/compile/compile");
var task_names_1 = require("./task-names");
function default_1() {
    config_env_1.task(task_names_1.TASK_COMPILE, "Compile all secret contracts")
...
function compileTask(_a, env) {
    var docker = _a.docker, sourceDir = _a.sourceDir, force = _a.force, skipSchema = _a.skipSchema;
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, checkEnv_1.canCompile(env)];
                case 1:
                    ...
                    return [4 /*yield*/, compile_1.compile(docker, sourceDir, force, skipSchema)];
