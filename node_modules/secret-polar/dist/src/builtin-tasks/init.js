...
var project_creation_1 = require("../internal/cli/project-creation");
var config_env_1 = require("../internal/core/config/config-env");
var task_names_1 = require("./task-names");
function default_1() {
    var _this = this;
    config_env_1.task(task_names_1.TASK_INIT, "Initializes a new project in the given directory")
        ...
        .setAction(function (_a, _) {
        var projectName = _a.projectName, templateName = _a.templateName, destination = _a.destination;
        return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, project_creation_1.createProject(projectName, templateName, destination)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/];
                }
