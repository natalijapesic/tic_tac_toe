...
function help(_a, env) {
    var taskName = _a.task;
    return __awaiter(this, void 0, void 0, function () {
        var packageJson, helpPrinter;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, packageInfo_1.getPackageJson()];
                case 1:
                    packageJson = _b.sent();
                    helpPrinter = new help_printer_1.HelpPrinter(POLAR_NAME, packageJson.version, polar_params_1.POLAR_PARAM_DEFINITIONS, env.tasks);
