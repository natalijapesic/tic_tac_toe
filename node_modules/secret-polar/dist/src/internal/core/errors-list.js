...
exports.ERROR_RANGES = exports.ERRORS = exports.getErrorCode = exports.ERROR_PREFIX = void 0;
exports.ERROR_PREFIX = 'PE';
...
exports.ERRORS = {
    GENERAL: {
        ...
        INVALID_NODE_VERSION: {
            number: 2,
            message: "Polar doesn't support your Node.js version. It should be %requirement%.",
        ...
        CONTEXT_PRE_NOT_DEFINED: {
            number: 6,
            message: 'Polar Runtime Environment is not defined in the PolarContext.',
        ...
        CONTEXT_PRE_ALREADY_DEFINED: {
            number: 7,
            message: 'Polar Runtime Environment is already defined in the PolarContext',
        ...
        NON_LOCAL_INSTALLATION: {
            number: 12,
            message: 'Trying to use a non-local installation of Polar, which is not supported.\nPlease install Polar locally using npm or Yarn, and try again.',
    ...
    NETWORK: {
        ...
        INVALID_GLOBAL_CHAIN_ID: {
            number: 101,
            message: 'Polar was set to use chain id %configChainId%, but connected to a chain with id %connectionChainId%.',
    ...
    TASK_DEFINITIONS: {
        ...
        PARAM_CLASHES_WITH_POLAR_PARAM: {
            number: 202,
            message: 'Could not set param %paramName% for task %taskName% because its name is used as a param for Polar.',
    ...
    RESOLVER: {
        ...
        INVALID_IMPORT_PROTOCOL: {
            number: 406,
            message: "Invalid import %imported% from %from%. Polar doesn't support imports via %protocol%.",
        ...
        INVALID_IMPORT_ABSOLUTE_PATH: {
            number: 407,
            message: "Invalid import %imported% from %from%. Polar doesn't support imports with absolute paths.",
    ...
    BUILTIN_TASKS: {
        ...
        JSONRPC_UNSUPPORTED_NETWORK: {
            number: 605,
            message: 'Unsupported network for JSON-RPC server. Only Polar is currently supported.',
