...
task('example2', 'example task', function (_ret) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    return [2 /*return*/, 28];
}); }); });
task('example', 'example task', function (__, _a) {
    var run = _a.run;
    return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_b) {
        return [2 /*return*/, run('example2')];
    }); });
});
module.exports = {
    networks: {
